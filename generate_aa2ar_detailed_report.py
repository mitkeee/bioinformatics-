#!/usr/bin/env python3
"""
Generate Comprehensive Detailed Report for AA2AR
...
def generate_aa2ar_report():
    """Generate comprehensive report for AA2AR protein"""
    ...
    print(f"Processing AA2AR from {pdb_file}...")
    ...
    try:
        ...
        write_comprehensive_report(df, "AA2AR", params, report_path)
        print("OK")
...
def write_legend(f, params):
    ...
    f.write(f"  - nc6_threshold = {params.nc6_threshold} (minimum neighbors at 6Å)\n")
    f.write(f"  - nc10_threshold = {params.nc10_threshold} (minimum neighbors at 10Å)\n")
    f.write(f"  - uni6_threshold = {params.uni6_threshold} (minimum uniformity at 6Å)\n")
    f.write(f"  - uni10_threshold = {params.uni10_threshold} (minimum uniformity at 10Å)\n")
